-- CuraFlow Hospital Management System Database Schema - FIXED VERSION
...
-- In production, you'd want more specific policies based on clinic_id
...
RETURNS VOID AS $$
BEGIN
    -- This function can be extended based on your session management needs
    UPDATE doctors 
...
BEGIN
    ...
    -- In a real implementation, you'd use Supabase Auth functions
...
BEGIN
    ...
    ('curaflow-central', 'CuraFlow Central Hospital', '123 Health St, Wellness City, 12345', '(123) 456-7890', 'contact@curaflow.com'),
    ('sunrise-medical', 'Sunrise Medical Clinic', '456 Wellness Ave, Sunnyside, 54321', '(987) 654-3210', 'info@sunrisemedical.com')
    ON CONFLICT (id) DO NOTHING;

    -- Insert sample departments
    INSERT INTO departments (clinic_id, name) VALUES
    ('curaflow-central', 'Cardiology'),
    ('curaflow-central', 'Pediatrics'),
    ('curaflow-central', 'Dermatology'),
    ('curaflow-central', 'Neurology'),
    ('curaflow-central', 'General Medicine'),
    ('sunrise-medical', 'Dermatology'),
    ('sunrise-medical', 'Neurology'),
    ('sunrise-medical', 'Orthopedics')
    ON CONFLICT DO NOTHING;

    -- Insert sample sessions
    INSERT INTO sessions (clinic_id, name, start_time, end_time) VALUES
    ('curaflow-central', 'Morning', '09:00', '13:00'),
    ('curaflow-central', 'Afternoon', '14:00', '18:00'),
    ('curaflow-central', 'Evening', '18:00', '21:00'),
    ('sunrise-medical', 'Morning', '08:30', '12:30'),
    ('sunrise-medical', 'Afternoon', '13:30', '17:30')
    ON CONFLICT DO NOTHING;
END;
$$ LANGUAGE plpgsql SECURITY DEFINER;
