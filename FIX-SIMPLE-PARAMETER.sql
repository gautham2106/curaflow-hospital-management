-- =====================================================
-- FIX SUPERADMIN AUTHENTICATION - SIMPLE PARAMETER FIX
-- =====================================================
-- 
-- This fixes the parameter name conflict by using different names
-- Run this in Supabase SQL Editor
-- =====================================================

-- Drop and recreate the function with different parameter names
...
BEGIN
    ...
    INTO admin_record
    FROM superadmins 
    WHERE superadmins.username = p_user  -- Use p_user instead of p_username
